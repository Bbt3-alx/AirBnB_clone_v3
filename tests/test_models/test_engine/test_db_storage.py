...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        retrieved_sate = storage.get(State, state_instance.id)
    ...
    def test_count(self):
        ...
        city_data = {"Nane": "Bamako", "state_id": state_instance.iid}
